# Generated by Powerlevel10k configuration wizard on 2024-05-30 at 17:06 BST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=167
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=215
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=105
  ...
  ###########[ timewarrior: timewarrior tracking status (https://timewarrior.net/) ]############
  # Timewarrior color.
  typeset -g POWERLEVEL9K_TIMEWARRIOR_FOREGROUND=015
  ...
  ##############[ taskwarrior: taskwarrior task count (https://taskwarrior.org/) ]##############
  # Taskwarrior color.
  typeset -g POWERLEVEL9K_TASKWARRIOR_FOREGROUND=015
  ...
  ###########[ ip: ip address and bandwidth usage for a specified network interface ]###########
  # IP color.
  typeset -g POWERLEVEL9K_IP_FOREGROUND=201
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='$P9K_IP_INTERFACE${P9K_IP_RX_RATE:+ %010F<$P9K_IP_RX_RATE}${P9K_IP_TX_RATE:+ %045F>$P9K_IP_TX_RATE}'
  ...
  typeset -g POWERLEVEL9K_BATTERY_DISCONNECTED_FOREGROUND=022
  ...
  #####################################[ wifi: wifi speed ]#####################################
  # WiFi color.
  typeset -g POWERLEVEL9K_WIFI_FOREGROUND=201
  # Custom icon.
